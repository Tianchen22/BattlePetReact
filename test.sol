...
//
//     ___                       ____   ____             __ 
//    /   | ____ ____     ____  / __/  / __ \__  _______/ /_
//   / /| |/ __ `/ _ \   / __ \/ /_   / /_/ / / / / ___/ __/
//  / ___ / /_/ /  __/  / /_/ / __/  / _, _/ /_/ (__  ) /_  
// /_/  |_\__, /\___/   \____/_/    /_/ |_|\__,_/____/\__/  
//       /____/                                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xDf8eEf2a68775db7FB3179e243231e06d7d75113];
...
// File: contracts/AgeofRustContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract AgeofRustContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Age of Rust";
    string public symbol = "AGEOFRUST";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/PWnr3FQZmN5b82TK0Ac8/contract-metadata";
  }
